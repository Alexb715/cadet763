export const DEFAULT_CONTENT = {
  ...
  heroLead: {
    en: 'A youth program for ages 12 to 18 that builds citizenship, leadership and a love of aviation, free of charge, every Tuesday night in Ste-Marie-de-Kent.',
    fr: 'Un programme pour les jeunes de 12 à 18 ans qui développe le civisme, le leadership et l’amour de l’aviation, gratuit, chaque mardi soir à Ste-Marie-de-Kent.',
  },
  ...
  contactTitle: {
    en: 'Drop in any Tuesday night.',
    fr: 'Passez nous voir un mardi soir.',
  },
  contactBody: {
...
export const POSTS = [
  ...
  { id: 2, cat: 'training', date: '2025-10-15', likes: 62, comments: 11, shares: 4,
    ...
    body: {
      ...
      fr: 'Félicitations au F/Sgt Gallant, au Sgt Léger, au Cpl Arsenault et au Cdt 1 Vautour, tous quatre sont sélectionnés pour la bourse de pilote de planeur 2026. Six semaines à Debert cet été pour obtenir leurs ailes.',
    } },
  ...
  { id: 5, cat: 'events', date: '2025-09-20', likes: 38, comments: 2, shares: 1,
    ...
    body: {
      en: 'Great turnout for our season opener: 38 cadets on parade including 9 new faces. Reminder: uniform inspection next Tuesday at 18:30 sharp.',
      fr: 'Belle participation pour notre soirée d’ouverture : 38 cadets en formation, dont 9 nouveaux visages. Rappel : inspection d’uniforme mardi prochain à 18 h 30 pile.',
    } },
